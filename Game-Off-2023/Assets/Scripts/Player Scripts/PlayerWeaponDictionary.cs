...
public class PlayerWeaponDictionary
{
    ...
    private float[] pistolValues =      {1                  ,2              ,3              ,5                ,1          ,9                 ,.1f                 };
    private float[] swordValues =       {1                  ,2              ,3              ,5                ,1          ,9                 ,.1f                 };
    private float[] sMGValues =         {.3f                ,45             ,1              ,5                ,1          ,9                 ,.1f                 };
    private float[] shotgunValues =     {1                  ,2              ,10             ,5                ,25         ,9                 ,.4f                 };
    private float[] rifleValues =       {1                  ,2              ,3              ,5                ,1          ,9                 ,.1f                 };
    private float[] grenadeValues =     {1                  ,2              ,3              ,5                ,1          ,9                 ,.1f                 };
